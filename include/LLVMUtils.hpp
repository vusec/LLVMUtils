...
auto demangle(const char *) -> std::string;
auto demangle(const std::string) -> std::string;
...
auto getFnTy(llvm::Type *, std::vector<llvm::Type *> &);
...
auto addMetadata(llvm::Value &, llvm::StringRef &, llvm::MDNode &) -> bool;
